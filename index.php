...
<body>
	<div class="container">
		...
		<!-- footer -->
		<footer>
			<p>&copy; Annisa Fitri, Teknik Informatika</p>
		</footer><!-- endof footer -->
